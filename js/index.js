(function() {
  ...
  MESSAGES.push({
    delay: 0,
    text: "Dalam indahnya wisata di Yogyakarta"
  });

  MESSAGES.push({
    delay: 1000,
    text: "menuju ke Waduk Sermo yang indah dan luas terbentang."
  });

  MESSAGES.push({
    delay: 2000,
    text: "Kami mahasiswa KKN-PPM UGM 2018 Unit Hargotirto"
  });

  MESSAGES.push({
    delay: 3000,
    text: "Mempersembahkan website dengan segala jenis informasi yang anda perlukan"
  });

  MESSAGES.push({
    delay: 4000,
    text: "untuk mengetahui lebih dalam tentang seluk-beluk Desa Sejahtera Hargotirto"
  });
